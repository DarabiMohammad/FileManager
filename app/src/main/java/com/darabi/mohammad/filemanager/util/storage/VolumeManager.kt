...
class VolumeManager @Inject constructor (
    ...
    private val primaryExternalStorageManager: PrimaryExternalStorageManager,
...
//
////    private val  externalStorage by lazy { primaryExternalStorageManager.externalStorage }
//
...
//        else EMPTY_STRING
//
//    private fun getPrimaryExternalStorageDirs() = getExternalStorageDirectory()
//
...
//    }
//
//    private fun getFolders(path: String):List<File> {
...
//        Volume(externalStorage.name, externalStorage.path, isFile = false, isHidden = false)
//
